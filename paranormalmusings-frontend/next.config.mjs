...
const nextConfig = {
  ...
  async headers() {
    ...
    const isStaging = process.env.VERCEL_ENV === 'preview' || isDev

    const scriptSrc = isDev
      ? "'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net"
      : "'self' https://challenges.cloudflare.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net"
